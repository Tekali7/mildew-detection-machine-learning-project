...
def page_project_hypothesis_body():
    ...
    st.success(
        ...
        f"typically the white powder can be seen and can be anywhere on the leaf.. \n\n"
        f"* An Image Montage shows that typically a powdery mildew leafs white marks over it. "
